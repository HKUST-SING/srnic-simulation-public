...
public:
	...
	// lwx, for timeout
	void TriggerTrans(Ptr<RdmaQueuePair> qp);
	//
	 ...
	 * CUSTOM
	 *********************/
	double m_custom_alpha, m_custom_beta;
	void HandleAckCustom(Ptr<RdmaQueuePair> qp, Ptr<Packet> p, CustomHeader &ch);
};
