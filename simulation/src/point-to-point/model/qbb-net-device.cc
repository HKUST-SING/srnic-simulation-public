...
namespace ns3 {
		...
		QbbNetDevice::Receive(Ptr<Packet> packet)
	{
		...
		// lwx,
		// std::cout << "add rece trace in qbbnetdevice.h" << "\n";
		// 
		m_macRxTrace(packet);
	...
	//lwx
	void QbbNetDevice::DropPkgDueToBufferOverFlow(uint32_t qIndex, Ptr<Packet> packet, CustomHeader &ch){
		// std::cout << "add drop trace" << "\n";
