...
// lwx
void NetDevice::DropPkgDueToBufferOverFlow(uint32_t qIndex, Ptr<Packet> packet, CustomHeader &ch){
  printf("NetDevice::DropPkgDueToBufferOverFlow not implemendted\n");
}
//
